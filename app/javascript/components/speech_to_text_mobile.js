...
const initReciteProgressBarMobile = () => {
  const reciteProgressBarMobile = document.getElementById('recite-progress-bar-mobile');
  if (reciteProgressBarMobile) {
     const bar = new ProgressBar.SemiCircle(reciteProgressBarMobile, {
      strokeWidth: 9,
      color: '#FE4A49',
      trailColor: '#E5E5E5',
      trailWidth: 5,
...
const bar = initReciteProgressBarMobile();
let current = 0;
const speechToTextMobile = () => {
